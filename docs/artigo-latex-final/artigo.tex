...
\begin{center}
\footnotesize
\begin{tabular}{|p{6cm}|*{32}{c|}}
\hline
\textbf{ETAPAS} & \multicolumn{4}{c|}{MAI} & \multicolumn{4}{c|}{JUN} & \multicolumn{4}{c|}{JUL} & \multicolumn{4}{c|}{AGO} & \multicolumn{4}{c|}{SET} & \multicolumn{4}{c|}{OUT} & \multicolumn{4}{c|}{NOV} & \multicolumn{4}{c|}{DEZ} \\
\hline
...
Documentação da arquitetura do jogo 
&  &  &  &  &  &  &  &  &  &  &  & X & X & X & X & X & X & X & X & X &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
...
Ajustes e entrega final do artigo 
&  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & X & X \\
\hline
